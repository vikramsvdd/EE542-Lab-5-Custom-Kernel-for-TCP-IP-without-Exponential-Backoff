 ...
 */
#define MAX_TCP_WINDOW		65535U /*lab5*/
...
#define TCP_FASTRETRANS_THRESH 1 /*lab5*/
...
#define TCP_SYN_RETRIES	 5 /*lab5*/	/* This is how many retries are done
...
#endif
#define TCP_RTO_MAX	((unsigned)(3*HZ/5)) /*lab5*/
#define TCP_RTO_MIN	((unsigned)(HZ/10))/*lab5*/
#define TCP_TIMEOUT_MIN	(2U) /* Min timeout for TCP timers in jiffies */
#define TCP_TIMEOUT_INIT ((unsigned)(1*HZ/5))/*lab5*/	/* RFC6298 2.1 initial RTO value	*/
...
#define TCPOPT_WINDOW		6/*lab5*/	/* Window scaling */
...
/* Flags in tp->nonagle */
#define TCP_NAGLE_OFF		0/*lab5*/	/* Nagle's algo is disabled */
